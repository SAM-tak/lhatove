...
bool lhopen_love_math(Context &ctx)
{
	...
	return ctx.func(m, "random", "p^ -> number^;", lh_random, nullptr)
		...
		&& ctx.member(m, "Transform", "translate", "p^self^, number^, number^ -> love.math.Transform;", lh_Transform_translate, nullptr)
		&& ctx.member(m, "Transform", "rotate", "p^self^, number^ -> love.math.Transform;", lh_Transform_rotate, nullptr)
		&& ctx.member(m, "Transform", "scale", "p^self^, number^ -> love.math.Transform;", lh_Transform_scale, nullptr)
		&& ctx.member(m, "Transform", "scale", "p^self^, number^, number^ -> love.math.Transform;", lh_Transform_scale, nullptr)
		&& ctx.member(m, "Transform", "shear", "p^self^, number^, number^ -> love.math.Transform;", lh_Transform_shear, nullptr)
		&& ctx.member(m, "Transform", "reset", "p^self^ -> love.math.Transform;", lh_Transform_reset, nullptr)
		&& ctx.member(m, "Transform", "setTransformation", "p^self^, number^, number^, ... -> love.math.Transform;", lh_Transform_setTransformation, nullptr)
		// any^ rather than love.math.Transform: a member taking the type beside
		// members answering it loops lhat_program_install (docs/porting/lhat-issues.md).
		&& ctx.member(m, "Transform", "apply", "p^self^, any^ -> love.math.Transform;", lh_Transform_apply, nullptr)
		&& ctx.member(m, "Transform", "inverse", "p^self^ -> love.math.Transform;", lh_Transform_inverse, nullptr)
